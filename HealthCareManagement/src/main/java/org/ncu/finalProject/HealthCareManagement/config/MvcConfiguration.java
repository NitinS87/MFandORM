package org.ncu.finalProject.HealthCareManagement.config;
...
@Configuration
@ComponentScan(basePackages="org.ncu.finalProject.HealthCareManagement")
@EnableWebMvc
public class MvcConfiguration extends WebMvcConfigurerAdapter{
	...
	public DataSource getDataSource() {
		...
		dataSource.setPassword("Nitin@243");
		return dataSource;
	}
