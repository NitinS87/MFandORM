...
<body>
	...
	<div class="container">
		...
		<form:form action="processSpecialistMeetingForm" method="post"
			modelAttribute="meeting">

			<div class="form-group ">
				<label for="meeting_id">Meeting Id(*)</label>
				<form:input type="text" path="meeting_id" readonly="true" />
				<form:errors path="meeting_id" cssClass="error" />
			</div>

			<div class="form-group md-5">
				<label for="customer_id">Customer Id(*)</label>
				<form:input type="text" path="customer_id" readonly="true" />
			...
			<div class="form-group md-5">
				...
				<form:input type="time" path="time" readonly="true" />
				<form:errors path="time" cssClass="error" />
			</div>

			<div class="form-group md-5">
				<label for="location">Location(*)</label>
				<form:input type="text" path="location" readonly="true" />
				<form:errors path="location" cssClass="error" />
			</div>

			<div class="form-group md-5">
				<label for="logistics">Logistics: </label>
				<form:checkboxes path="logistics"
					items="${meeting.logisticsOptions}" />
			</div>
